...
use quantitative_data_analysis_rs::infrastructure::stock_repository;
use quantitative_data_analysis_rs::infrastructure::stock_repository::data_format::DataFormatType;
use quantitative_data_analysis_rs::infrastructure::stock_repository::yahoo_finance_api::YahooFinanceAPI;
...
use stock_repository::file_system::FileSystem;
